...
public class PinYinUtil
{
    ...
    /// 二级汉字数组
    /// </summary>
    private static string[] otherChinese = {
    ...
    /// 二级汉字对应拼音数组
    /// </summary>
    private static string[] otherPinYin = {
    ...
    /// 把汉字转换成拼音(全拼)
    /// </summary>
    public static string GetFull(string str, string prefix)
    {
        if (string.IsNullOrEmpty(str)) return string.Empty;
    ...
    /// <returns></returns>
    public static string GetAbbr(string str, string prefix)
    {
        if (string.IsNullOrEmpty(str)) return string.Empty;
        ...
        foreach (var t in chs)
        {
            ...
            if (!string.IsNullOrWhiteSpace(p))
            {
                sb.Append(prefix).Append(GetFirst(t));
            }
        }
